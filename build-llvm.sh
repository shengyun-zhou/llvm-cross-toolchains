...
if [ -z "$SKIP_LLVM_BUILD" ]; then
    ...
    cmake .. -Wno-dev -G Ninja $LLVM_CMAKE_FLAGS $HOST_CMAKE_FLAGS -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="$OUTPUT_DIR" -DCMAKE_CXX_VISIBILITY_PRESET=hidden \
