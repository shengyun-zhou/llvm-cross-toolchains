...
cmake .. -G Ninja $WAMR_RPATH_CMAKE_FLAGS $HOST_CMAKE_FLAGS -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="$OUTPUT_DIR" -DLLVM_DIR="$OUTPUT_DIR/lib/cmake/llvm" -DWAMR_BUILD_WITH_CUSTOM_LLVM=1 \
